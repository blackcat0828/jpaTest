...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
	...
	//파라미터에 전달할 객체를 생성
	//여기서는 세션에서 객체를 가져온다.
	//이 설정을 적용하기 위해 WebMvcConfigurer에 추가해줘야한다. 
	@Override
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mvcContatiner, NativeWebRequest webRequest, 
